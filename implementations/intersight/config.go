...
const defaultEndpoint = "https://intersight.com"
...
func (c ConnectionConfig) NewAPICaller(ctx context.Context, timeout time.Duration, httpClient *http.Client) implementations.APICaller {
	return newAPICaller(ctx, c, timeout, httpClient)
}
